...
$play_button = ' title="Play" id="ja-btn-play"><i class="fa fa-play"></i><h3>'.$item->title.'</h3>';
...
if ($ctm_source == 'other') {
	...
	echo '<img class="ja-video embed-responsive-item" width="'.$width.'" height="'.$height.'" src="'.$img_thumb.'" alt="" />';
