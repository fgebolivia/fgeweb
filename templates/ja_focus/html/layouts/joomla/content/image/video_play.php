...
if($ctm_source == 'youtube') {
  ...
  if ($url) {
    ...
    echo '<iframe class="ja-video embed-responsive-item" width="'.$width.'" height="'.$height.'" src="'.$url.'" frameborder="0" allowfullscreen></iframe>';
  }
  ...
  if($src) {
    ...
    <div id="jp_container_1" class="jp-video embed-responsive-item clearfix" role="application" aria-label="media player" style="width: <?php echo $width+2; ?>px;">
