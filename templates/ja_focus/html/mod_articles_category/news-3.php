...
?>
<div class="row ja-news ja-news-3 <?php echo $moduleclass_sfx; ?>">
	...
	<?php if ($grouped) : ?>
		...
		<div class="ja-news-group">
			...
			?>
					...
					<div class="<?php if($count==1 || $count==2): echo 'news-big col-md-6'; elseif($count%2==1 && $count>2): echo 'news-normal col-md-6 clear'; else: echo 'news-normal col-md-6'; endif; ?> clearfix link-<?php echo $color; ?>">
