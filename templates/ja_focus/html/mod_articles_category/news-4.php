...
?>
<div class="row ja-news ja-news-4 <?php echo $moduleclass_sfx; ?>">
		...
		<div class="ja-news-group">
			<div class="col-xs-12">
				...
				?>
					...
					<div class="<?php if($count==1): echo 'news-big col-md-6'; elseif($count%2==0): echo 'news-normal col-md-6 clear clearfix'; else: echo 'news-normal col-md-6 clearfix'; endif; ?> link-<?php echo $color; ?>">
