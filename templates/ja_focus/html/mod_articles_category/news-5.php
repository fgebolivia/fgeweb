...
?>
<div class="row ja-news ja-news-5 <?php echo $moduleclass_sfx; ?>">
		...
		<div class="ja-news-group">
			<div class="col-xs-12">
				...
				<?php foreach ($group as $item) : ?>
					...
					<div class="<?php if($count==1): echo 'news-big col-md-12'; else: echo 'news-medium col-md-4 clearfix'; endif; ?> link-<?php echo $color; ?>">
