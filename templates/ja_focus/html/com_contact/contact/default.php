...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
		...
		<div class="col-md-4 col-xs-12 contact-information">
			<div class="inner">
				...
				<div class="box-contact">
					<!-- Contact -->
					<?php  echo '<h3 class="contact-title">'. JText::_('COM_CONTACT_DETAILS').'</h3>';  ?>
		...
		<div class="col-md-8 col-xs-12 contact-right">
			...
			<?php if ($this->contact->misc && $this->params->get('show_misc')) : ?>
				<div class="box-contact contact-miscinfo">
					<h3 class="contact-title"><?php echo JText::_('COM_CONTACT_OTHER_INFORMATION');?></h3>
			...
			<?php  echo '<h3 class="contact-title">'. JText::_('COM_CONTACT_EMAIL_FORM').'</h3>';  ?>
	...
	<?php endif; ?>
	 ...
	 <!-- <?php if ($this->contact->image && $this->params->get('show_image') && ($this->params->get('presentation_style') != 'plain')) : ?>
	...
	<?php if ($this->contact->con_position && $this->params->get('show_position') && ($this->params->get('presentation_style') != 'plain')) : ?>
		<dl class="contact-position dl-horizontal">
	...
	<?php if ($this->params->get('allow_vcard') && ($this->params->get('presentation_style') != 'plain')) :	?>
		<?php echo JText::_('COM_CONTACT_DOWNLOAD_INFORMATION_AS');?>
			<a href="<?php echo JRoute::_('index.php?option=com_contact&amp;view=contact&amp;id='.$this->contact->id . '&amp;format=vcf'); ?>">
			<?php echo JText::_('COM_CONTACT_VCARD');?></a>
	<?php endif; ?>
