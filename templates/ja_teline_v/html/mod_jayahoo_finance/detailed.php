		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane <?php if($index == 0) echo 'active'; ?>" id="<?php echo 'tab-'.$module->id.'-'.$item->symbol; ?>">
				...
				<table class="table">
					<tbody>
						<tr>
							<td style="width:15%" class="head"><?php echo JText::_('MOD_JAYAHOO_FINANCE_OPEN'); ?></td>
							<td style="width:25%"><?php echo $item->Open; ?></td>
							<td style="width:30%" class="head"><?php echo JText::_('MOD_JAYAHOO_FINANCE_MKTCAP'); ?></td>
							<td style="width:30%"><?php echo $item->MarketCapitalization; ?></td>
						</tr>
						<tr>
