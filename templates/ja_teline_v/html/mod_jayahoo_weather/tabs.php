...
<div id="ja-weather-<?php echo $module->id; ?>" class="ja-weather">
  <div role="tabpanel">
    ...
    <ul class="nav nav-tabs" role="tablist">
      <?php foreach($list as $index => $item): ?>
        ...
        <li role="presentation" title="<?php echo addslashes($info->location->city); ?>" class="<?php if($index == 0) echo 'active'; ?>">
          <a href="#<?php echo 'tab-'.$module->id.'-'.$woeid; ?>" aria-controls="<?php echo 'tab-'.$module->id.'-'.$woeid; ?>" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
      <?php foreach($list as $index => $item): ?>
        <?php list($woeid, $info) = $item; ?>
        <div role="tabpanel" class="tab-pane panel-default <?php if($index == 0) echo 'active'; ?>" id="<?php echo 'tab-'.$module->id.'-'.$woeid; ?>">
              ...
              <table class="table">
                ...
                <tr>
                  <td>
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <span title="<?php echo JText::_('MOD_JAYAHOO_WEATHER_PRESSURE'); ?>"><i class="wi wi-sprinkles"></i> <?php echo ModJaYahooWeatherHelper::formatPressure((float)$info->atmosphere->pressure,$info->units->pressure, $pressure_unit); ?></span>
                  </td>
                </tr>
                </tbody>
              </table>
