...
<?php if(!$isAjax): ?>
	...
	<?php if($show_section_title) : ?>
		<div class="magazine-section-heading gallery-section-heading">
...
<?php if ($direction == 'hoz'): ?>
	...
	foreach ($items as $item) : ?>
		...
		<?php endif ?>
		<div class="col col-xs-12 col-sm-<?php echo $col_width ?> magazine-item photos-item">
	...
	<div class="row-articles equal-height">
		...
		<?php foreach ($items as $item) : ?>
			<?php if ($i == 0): /* start new col */ ?>
				<div class="col col-xs-12 col-sm-<?php echo $col_width ?> magazine-item" itemscope itemtype="http://schema.org/ImageObject">
			<?php endif ?>
