...
if ($aparams->get('article_ordering') == 'startdate'){
    $items = JATemplateHelper::getArticleByStart($aparams, $catids, $display_items);    
} else {
...
?>
<?php if(!$isAjax): ?>
<div class="row magazine-list events-list equal-height">
	<!-- MAGAZINE LISTING -->
