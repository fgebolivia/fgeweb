...
class JFormFieldContacts extends JFormField
{
	...
	protected function getInput()
	{
		...
		$script[] = '		var ids = document.id("' . $this->id . '_id").value;';
		$script[] = '		if(ids != "") {';
		...
		$html[] = '<input type="text" class="input-large" id="' . $this->id . '_name" value="' . $title . '" readonly="readonly" size="255" />';
