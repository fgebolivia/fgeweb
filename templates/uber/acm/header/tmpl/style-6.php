...
$headright = $doc->countModules('head-search or languageswitcherload or right-menu');
...
<?php endif; ?>
<header id ="uber-header-<?php echo $module->id; ?>" class="wrap uber-header header-6 dark-color">
