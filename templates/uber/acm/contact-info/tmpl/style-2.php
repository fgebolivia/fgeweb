...
<div class="section-inner <?php echo $helper->get('block-extra-class'); ?>">
  ...
  <div id="uber-contact-<?php echo $module->id; ?>" class="uber-contact-info style-2 <?php if(!($contacInfoImage || $contacInfoMap)): ?> no-background <?php endif; ?> <?php if($fullWidth): ?>full-width <?php endif; ?>">
