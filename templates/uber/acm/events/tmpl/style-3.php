...
<div class="section-inner <?php echo $helper->get('block-extra-class'); ?>" <?php if($helper->get('block-bg')) : ?>style="background-image: url('<?php echo $helper->get('block-bg'); ?>')"<?php endif; ?> >
  ...
  <div class="acm-event">
    <div class="container">
  	...
  	<div class="style-3 event-items <?php echo $menuStyle; ?>">
  		<?php
        for ($i=0; $i < $count; $i++) :
      ?>
  		<div class="event-item row">
          <div class="col-md-6 <?php if( ($i % 2) == 0) echo 'pull-right'; else echo 'pull-left'; ?>">
            <div class="item-inner">
              <div class="event-datetime">
                ...
                <span class="time"><?php echo $helper->get('data.event-time', $i); ?></span>
              </div>
