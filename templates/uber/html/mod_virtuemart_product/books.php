...
?>
<div class="vmgroup<?php echo $params->get ('moduleclass_sfx') ?> section-inner books-view">
	...
	if ($display_style == "div") {
		?>
		<div id="bk-list" class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails row bk-list">
            ...
            ?>
            <div class="pk-desc">
            <?php  echo shopFunctionsF::limitStringByWord ($product->product_s_desc, 70, ' ...') ?>
            </div>
            <?php } ?>
			...
			if ($col == $products_per_row && $products_per_row && $col < $totalProd) {
				echo "	</div><div class='bk-list row' style='clear:both;'>";
				$col = 1;
			} else {
				$col++;
			}
