    ...
    <div>
        ...
        <div class="row-fluid">
        	<div class="span12">
                ...
                <div class="pull-right" id="virtuemart" style="display:none;">
            		<select name="virtuemart" id="virtuemart_id" style="margin-left:15px !important;" onchange="javascript:changeSource(document.getElementById('source').value);">
                ...
                <div class="pull-right">
            		<select name="source" id="source" onchange="javascript:changeSource(this.value);">
                        ...
                        <option value="8"> VirtueMart </option>
                    </select>
                </div>
