...
if($id != "0"){
	...
	if(isset($params["enable_virtuemart"])){
		$enable_virtuemart = $params["enable_virtuemart"];
	}
...
<form class="form-horizontal" action="index.php" method="post" name="adminForm" id="adminForm">
    ...
    <div class="control-group">
        <label class="control-label"><?php echo JText::_("COM_IJOOMLA_SEO_ENABLE_VIRTUEMART"); ?></label>
        <div class="controls">
        	<fieldset class="radio btn-group" id="jform_enable_virtuemart">
                <?php
                    $no_checked = "";
                    $yes_cheched = "";
                    
                    if($enable_virtuemart == 0){
                        $no_checked = 'checked="checked"';
                    }
                    else{
                        $yes_cheched = 'checked="checked"';
                ...
                ?>
                <input type="hidden" name="enable_virtuemart" value="0">
				<input type="checkbox" <?php echo $yes_cheched; ?> value="1" name="enable_virtuemart" class="ace-switch ace-switch-5">
				<span class="lbl"></span>
              
            </fieldset>
            <span class="editlinktip hasTip" title="<?php echo JText::_("COM_IJOOMLA_SEO_ENABLE_VIRTUEMART_TIP"); ?>" >
			<img src="<?php echo JURI::root() . "administrator/components/com_ijoomla_seo/images/tooltip.png"; ?>" border="0"/></span>
        </div>
    </div>
