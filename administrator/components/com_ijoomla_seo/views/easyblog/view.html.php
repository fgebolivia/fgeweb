...
class iJoomla_SeoViewEasyblog extends JViewLegacy {
	...
	function createCriterias(){
		...
		$default = $app->getUserStateFromRequest('atype', 'atype', '');
		...
		$default = $app->getUserStateFromRequest('filter_state', 'filter_state', '');
