...
$customField = $form->getFieldsets();
foreach ($customField AS $k => $v) {
	if (preg_match('/fields\-[0-9]*/', $k))
		$fieldSets[$k] = $v;
}
?>
		...
		<fieldset>
			<ul class="nav nav-tabs">
				...
				<?php foreach ($fieldSets as $name => $fieldSet): ?>
					<li><a href="#attrib-<?php echo $name; ?>" data-toggle="tab"><?php echo JText::_($fieldSet->label, true) ?></a></li>
				<?php endforeach; ?>
			</ul>
			...
			<div class="tab-content">
				...
				<?php $this->show_options = 1; ?>
				<?php echo JLayoutHelper::render('joomla.edit.params', $this, JAPATH_CONTENT_TYPE.'/layouts/'); ?>
			</div>
